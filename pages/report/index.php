...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">任務回報管理：未審回報</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    		            			...
    		            			foreach($report_array as $report){
    		            				...
    		            				echo "
    					            		<tr>
    			                                ...
    			                                <td class=\"center\">
                                                    <a href=\"control.php?rid=".$report['rid']."&action=pass&uid=".$report['uid']."&mid=".$report['mid']."\" type=\"button\" class=\"btn btn-outline btn-success btn-xs\">完成</a>
                                                    <a href=\"control.php?rid=".$report['rid']."&action=fail\" type=\"button\" class=\"btn btn-outline btn-warning btn-xs\">失敗</a>
    ...
    $(document).ready(function() {
        ...
        $('a[href="/run/admin/pages/report/index.php"]').addClass("active");
        $('a[href="/run/admin/pages/report/index.php"]').parent().parent().removeClass("collapse");
    });
    </script>
